...
# título
st.title("ML Valor do Aluguel - Predição de Valores de Alugueis")

# subtítulo
st.markdown("Este é um Data App utilizado para exibir a solução de Machine Learning para o problema de predição de valores alugueis de imóveis. Projeto feito durante BootCamp em Ciencia de Dados.")
